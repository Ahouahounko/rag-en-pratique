...
devenir des exemples pédagogiques exécutables. Tous sont locaux, sauf le numéro
14 qui utilise explicitement OpenAI si le lecteur configure une clé.
...
| 05 | `lst:mecanisme_recursif` | Le mécanisme récursif, traduit en Python | python | [`05_mecanisme_recursif.py`](05_mecanisme_recursif.py) | exécutable |
...
| 12 | `lst:semantique_accumulation` | Détection de rupture par accumulation | python | [`12_semantique_accumulation.py`](12_semantique_accumulation.py) | exécutable |
